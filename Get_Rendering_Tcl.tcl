...
## set the model name and load case name. 
set modelName "TwoSpan_Segmental"	;		# The output folder will be named as "modelName_ODB" by the script.
set loadCaseName "none" ;		# Optional, If not provided, only model and modeshape data is saved. No load case specific data is saved.

## Set number of modeshapes to record

set recordModeShapes "no" ;		# Select if you want to record mode shape data or not. "yes" or "no"
set numModes 6
